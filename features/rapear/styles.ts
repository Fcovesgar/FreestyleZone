...
const styles = StyleSheet.create({
  ...
  wordProgressText: { color: '#FFFFFFB8', fontSize: 11, fontWeight: '600' },
  recordingCenterTimer: { color: '#FFFFFF', fontSize: 18, textAlign: 'center', lineHeight: 24 },
  recordingCloseButton: { position: 'absolute', top: 6, right: 14, width: 34, height: 34, borderRadius: 17, borderWidth: 1, borderColor: '#FFFFFF2E', backgroundColor: '#00000066', alignItems: 'center', justifyContent: 'center' },
