...
const styles = StyleSheet.create({
  ...
  recordingHeaderBar: { width: '100%', alignItems: 'center', justifyContent: 'flex-start', paddingHorizontal: 12 },
  recordingTopOverlayFrame: { width: '82%', borderRadius: 16, borderWidth: 1, borderColor: '#FFFFFF2E', backgroundColor: '#00000066', paddingVertical: 10, paddingHorizontal: 12, alignItems: 'center', gap: 4 },
  recordingTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%' },
  recordingBackOutsideButton: { position: 'absolute', left: 10, top: 18, width: 30, height: 30, borderRadius: 15, borderWidth: 1, borderColor: '#FFFFFF2E', backgroundColor: '#0000004D', alignItems: 'center', justifyContent: 'center', zIndex: 7 },
  recordingCenterMainRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, minHeight: 28 },
  recordingCenterMainText: { color: '#FFFFFF', fontSize: 24, fontWeight: '800', textAlign: 'center', maxWidth: '92%' },
  recordingCenterWordText: { fontSize: 27 },
  wordProgressWrap: { width: '100%', alignItems: 'center', gap: 4, marginTop: 2 },
  wordProgressTrack: { width: '72%', height: 6, borderRadius: 999, backgroundColor: '#FFFFFF24', overflow: 'hidden' },
  wordProgressFill: { height: '100%', borderRadius: 999, backgroundColor: '#A78BFA' },
  recordingCenterTimer: { color: '#FFFFFF', fontSize: 18, textAlign: 'center', lineHeight: 24 },
  ...
  liveSessionControlsRow: { width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', position: 'relative' },
  liveSessionStopButton: { width: 72, height: 72, borderRadius: 36, borderWidth: 1, borderColor: '#FCA5A5', backgroundColor: '#7F1D1DAA', alignItems: 'center', justifyContent: 'center' },
  liveSessionSwitchCameraButton: { position: 'absolute', right: 34, width: 54, height: 54, borderRadius: 27, borderWidth: 1, borderColor: '#FFFFFF33', backgroundColor: '#0000007A', alignItems: 'center', justifyContent: 'center' },
