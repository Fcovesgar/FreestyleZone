...
const styles = StyleSheet.create({
  ...
  recordingTopOverlay: { alignItems: 'center', justifyContent: 'flex-start', width: '100%', paddingHorizontal: 12, gap: 4 },
  recordingTopMetaRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  recordingModeInline: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  recordingTopMetaText: { color: '#FFFFFFD9', fontSize: 12, fontWeight: '600', letterSpacing: 0.5 },
  recordingCenterTimer: { fontSize: 28, textAlign: 'center', lineHeight: 34 },
  overlayWordWrapper: { width: '72%', borderRadius: 10, backgroundColor: '#00000038', paddingVertical: 6, paddingHorizontal: 10, alignItems: 'center', alignSelf: 'center', marginTop: 2 },
  overlayWordValue: { color: '#FFFFFF', fontSize: 32, fontWeight: '700', textAlign: 'center' },
  recordingFinishFloating: { position: 'absolute', right: 14, zIndex: 5 },
