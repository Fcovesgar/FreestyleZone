...
const styles = StyleSheet.create({
  ...
  recordingCenterMainText: { color: '#FFFFFF', fontSize: 17, fontWeight: '700', textAlign: 'center', maxWidth: '90%' },
  recordingCenterTimer: { color: '#FFFFFF', fontSize: 24, textAlign: 'center', lineHeight: 30 },
