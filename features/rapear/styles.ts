...
const styles = StyleSheet.create({
  ...
  recordingBackOutsideButton: { position: 'absolute', left: 10, top: 6, width: 30, height: 30, borderRadius: 15, borderWidth: 1, borderColor: '#FFFFFF2E', backgroundColor: '#0000004D', alignItems: 'center', justifyContent: 'center', zIndex: 7 },
  ...
  liveSessionControlsRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 18 },
  liveSessionStopButton: { width: 86, height: 86, borderRadius: 43, borderWidth: 1, borderColor: '#FCA5A5', backgroundColor: '#7F1D1DAA', alignItems: 'center', justifyContent: 'center' },
