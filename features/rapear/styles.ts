...
const styles = StyleSheet.create({
  ...
  recordingOverlayTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 999, backgroundColor: '#0000007A', borderWidth: 1, borderColor: '#FFFFFF2A', paddingHorizontal: 12, paddingVertical: 8 },
  recordingOverlayAppName: { color: '#FFFFFF', fontSize: 12, letterSpacing: 1.6, textTransform: 'uppercase', fontWeight: '700' },
  recordingOverlayTimer: { color: '#FFFFFF', fontSize: 18 },
