...
const styles = StyleSheet.create({
  ...
  recordingTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, width: '100%' },
  recordingBackButton: { width: 26, height: 26, borderRadius: 13, borderWidth: 1, borderColor: '#FFFFFF2E', backgroundColor: '#0000004D', alignItems: 'center', justifyContent: 'center' },
