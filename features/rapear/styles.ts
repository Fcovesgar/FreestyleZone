...
const styles = StyleSheet.create({
  ...
  recordingOverlayInfoBlock: { alignSelf: 'flex-start', borderRadius: 12, backgroundColor: '#000000C7', paddingHorizontal: 10, paddingVertical: 8 },
  recordingOverlayAppName: { color: '#FFFFFF', fontSize: 12, letterSpacing: 1.6, textTransform: 'uppercase', fontWeight: '700', marginBottom: 6 },
  recordingOverlayTimer: { color: '#FFFFFF' },
  trainingModeTag: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  recordingOverlayTag: { alignSelf: 'flex-start', borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4, backgroundColor: '#000000C7' },
