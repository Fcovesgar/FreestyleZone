...
const styles = StyleSheet.create({
  ...
  recordingTopHeader: { justifyContent: 'space-between', alignItems: 'flex-start', position: 'relative', minHeight: 70 },
  recordingHeaderLeft: { alignItems: 'flex-start', gap: 4 },
  recordingHeaderCenter: { position: 'absolute', left: 0, right: 0, top: 0, alignItems: 'center' },
  recordingCenterTimer: { fontSize: 30, textAlign: 'center' },
  recordingModeTagCompact: { marginTop: 0, paddingHorizontal: 8, paddingVertical: 3, backgroundColor: '#00000055', borderColor: '#FFFFFF1F' },
  overlayWordWrapper: { width: '70%', borderRadius: 12, backgroundColor: '#00000045', paddingVertical: 8, paddingHorizontal: 10, alignItems: 'center', alignSelf: 'center', marginTop: 2 },
  overlayWordValue: { color: '#FFFFFF', fontSize: 24, fontWeight: '700', textAlign: 'center' },
