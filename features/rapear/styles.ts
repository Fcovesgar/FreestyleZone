...
const styles = StyleSheet.create({
  ...
  recordingFinishFloating: { position: 'absolute', right: 14, zIndex: 6 },
  recordingFinishCircle: { width: 58, height: 58, borderRadius: 29, borderWidth: 1, borderColor: '#FFFFFF40', backgroundColor: '#00000078', alignItems: 'center', justifyContent: 'center' },
