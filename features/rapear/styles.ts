...
const styles = StyleSheet.create({
  ...
  recordingTopHeader: { justifyContent: 'flex-end' },
  recordingCenterOverlay: { alignItems: 'center', justifyContent: 'flex-start', width: '100%', paddingHorizontal: 14, marginTop: 6, gap: 10 },
  recordingCenterTimer: { fontSize: 34, textAlign: 'center' },
  overlayWordWrapper: { width: '92%', borderRadius: 20, borderWidth: 1, borderColor: '#FFFFFF40', backgroundColor: '#00000088', paddingVertical: 16, paddingHorizontal: 18, alignItems: 'center', alignSelf: 'center' },
  overlayWordValue: { color: '#FFFFFF', fontSize: 44, fontWeight: '900', textAlign: 'center' },
